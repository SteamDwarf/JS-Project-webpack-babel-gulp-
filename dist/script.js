...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])('.glazing_price_btn', '.popup_calc', 'popup_calc_close');
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])('.popup_calc_button', '.popup_calc_profile', 'popup_calc_profile_close');
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])('.popup_calc_profile_button', '.popup_calc_end', 'popup_calc_end_close');
  ...
  Object(_modules_checkNumInputs__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]');
  Object(_modules_checkNumInputs__WEBPACK_IMPORTED_MODULE_5__["default"])('.popup_calc input');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_4__["default"])(data);
...
/***/ "./src/js/modules/Clearing_Refresh.js":
/*!********************************************!*\
  !*** ./src/js/modules/Clearing_Refresh.js ***!
  \********************************************/
/*! exports provided: formClearer, tabsRefresh */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formClearer", function() { return formClearer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tabsRefresh", function() { return tabsRefresh; });
...
var tabsRefresh = function tabsRefresh(tabsSelector, contentSelector, activeClass) {
  var tabs = document.querySelectorAll(tabsSelector),
      content = document.querySelectorAll(contentSelector); //У каждого таба убирается класс активности
...
var formClearer = function formClearer(selectors) {
...
var calc = function calc(orderData) {
  var balconsImg = document.querySelectorAll('.balcon_icons_img img'),
  ...
  balconsImg.forEach(function (img) {
    Object(_getData__WEBPACK_IMPORTED_MODULE_1__["default"])('click', img, 'type', orderData);
  });
  checkboxes.forEach(function (checkbox, i) {
    Object(_getData__WEBPACK_IMPORTED_MODULE_1__["default"])('change', checkbox, 'glazing', orderData, lables[i]);
  });
  Object(_getData__WEBPACK_IMPORTED_MODULE_1__["default"])('input', inputWidth, 'width', orderData);
  Object(_getData__WEBPACK_IMPORTED_MODULE_1__["default"])('input', inputHeight, 'height', orderData);
  Object(_getData__WEBPACK_IMPORTED_MODULE_1__["default"])('change', windowProfile, 'profile', orderData);
...
var checkNumInputs = function checkNumInputs(inputsSelector) {
  ...
  var phoneRegex = /^(\s*)?(\+)?([- _():=+]?\d[- _():=+]?){10,14}(\s*)?$/;
  var errorMessage; //При введение в инпут не числа, символ заменяется на пустую строку
...
/* harmony import */ var _checkNumInputs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./checkNumInputs */ "./src/js/modules/checkNumInputs.js");
/* harmony import */ var _Clearing_Refresh__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Clearing_Refresh */ "./src/js/modules/Clearing_Refresh.js");
...
var forms = function forms(dataClient) {
  var formsElem = document.querySelectorAll('form');
  ...
  */
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            throw new Error("You response ".concat(url, " failed: ").concat(res.status));
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_9__["default"])('input[name="user_phone"]'); //Перебираются все формы и на каждую навешивается событие submit

  formsElem.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      if (form.getAttribute('data-form') === 'calc_end') {
        for (var key in dataClient) {
          object[key] = dataClient[key];
        }

        console.log(object);
        var selectors = ['#width', '#height', '#view_type', '[name="checkbox-test"]'];
        Object(_Clearing_Refresh__WEBPACK_IMPORTED_MODULE_10__["formClearer"])(selectors);
        Object(_Clearing_Refresh__WEBPACK_IMPORTED_MODULE_10__["tabsRefresh"])('.balcon_icons_img', '.big_img img', 'do_image_more');
      }
      ...
      postData('https://jsonplaceholder.typicode.com/users', json).then(function () {
...
var getData = function getData(action, target, field, orderData, optionalVar) {
    ...
    case 'INPUT':
      ...
      if (target.getAttribute('type') === 'checkbox') {
        ...
        if (optionalVar) {
          ...
          target.addEventListener(action, function () {
            var span = optionalVar.querySelector('span');
...
var imagesShow = function imagesShow() {
  var imgModal = document.querySelector('.popup_image'),
      imageBlock = document.querySelector('.works'),
      bigImage = imgModal.querySelector('img'); //Навешивается на блок с фотографиями событие нажатия ЛКМ
...
/* harmony default export */ __webpack_exports__["default"] = (imagesShow);
...
var modals = function modals(modalBtnSelector, modalElemSelector, modalCloseClass) {
  var modalBtn = document.querySelectorAll(modalBtnSelector),
      modalElem = document.querySelector(modalElemSelector),
      allModals = document.querySelectorAll('[data-modal]'),
      scrollWidth = calcScrollWidth(); //Данная функция подсчитывает ширину полосы прокрутки
...
var tabs = function tabs(wrapperSelector, headerSelector, contentSelector, activeClass) {
  var tabWrapper = document.querySelector(wrapperSelector),
      tabHeader = document.querySelectorAll(headerSelector),
      tabContent = document.querySelectorAll(contentSelector); //Данный метод обновляет табы, скрывает контент и убирая класс активности таба
  ...
  tabWrapper.addEventListener('click', function (e) {
    /*Если нажатие было произведено на элемент-таб, то начинают перебираться
      элементы.*/
    if (e.target.classList.contains(headerSelector.replace(/\./, '')) || e.target.parentNode.classList.contains(headerSelector.replace(/\./, ''))) {
      tabHeader.forEach(function (tab, i) {
